...
namespace Ogre
{
	ColibriOgreRenderable::ColibriOgreRenderable( IdType id, ObjectMemoryManager *objectMemoryManager,
...
//							getHlms( HLMS_UNLIT )->getDefaultDatablock() );
		...
		//We use this magic value 6372, to indicate this is a ColibriWidget
		//and thus needs special shaders from HlmsColibri
		setCustomParameter( 6372, Ogre::Vector4( 1.0f ) );
	}
	//-----------------------------------------------------------------------------------
	ColibriOgreRenderable::~ColibriOgreRenderable()
	{
	}
	//-----------------------------------------------------------------------------------
	/*Ogre::IndexBufferPacked* ColibriOgreRenderable::createIndexBuffer( VaoManager *vaoManager )
	{
	...
	//-----------------------------------------------------------------------------------
	void ColibriOgreRenderable::destroyVao( VertexArrayObject *vao, VaoManager *vaoManager )
	{
	...
	//-----------------------------------------------------------------------------------
	void ColibriOgreRenderable::setVao( VertexArrayObject *vao )
	{
		mVaoPerLod[0].clear();
		mVaoPerLod[1].clear();
	...
	//-----------------------------------------------------------------------------------
	const String& ColibriOgreRenderable::getMovableType(void) const
	{
		return BLANKSTRING;
	}
	//-----------------------------------------------------------------------------------
	const LightList& ColibriOgreRenderable::getLights(void) const
	{
		return this->queryLights(); //Return the data from our MovableObject base class.
	}
	//-----------------------------------------------------------------------------------
	void ColibriOgreRenderable::getRenderOperation( v1::RenderOperation& op , bool casterPass )
	{
		OGRE_EXCEPT( Exception::ERR_NOT_IMPLEMENTED,
						"ColibriOgreRenderable do not implement getRenderOperation."
	...
	//-----------------------------------------------------------------------------------
	void ColibriOgreRenderable::getWorldTransforms( Matrix4* xform ) const
	{
		OGRE_EXCEPT( Exception::ERR_NOT_IMPLEMENTED,
						"ColibriOgreRenderable do not implement getWorldTransforms."
						" You've put a v2 object in "
						"the wrong RenderQueue ID (which is set to be compatible with "
						"v1::Entity). Do not mix v2 and v1 objects",
	...
	{
		OGRE_EXCEPT( Exception::ERR_NOT_IMPLEMENTED,
						"ColibriOgreRenderable do not implement getCastsShadows."
						" You've put a v2 object in "
						"the wrong RenderQueue ID (which is set to be compatible with "
						"v1::Entity). Do not mix v2 and v1 objects",
